...
if v_cnt>0 then
log_pkg.log(p_message =>'Magaza adi ve unvani tekrar daxil etmek olmaz!!!',p_message_type =>'noncritical' );
...
select count(*) into v_cnt from store where name=p_name and address=p_address;
if v_cnt>0 then
log_pkg.log(p_message =>'Bu adli ve unvanli magaza artiq  movcuddur!!!' ,p_message_type => 'noncritical');
